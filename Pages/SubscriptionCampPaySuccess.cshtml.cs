...
{
    public class SubscriptionCampPaySuccessModel : PageModel
    {
        ...
        public SubscriptionCampPaySuccessModel(CoachContext context, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager,
            ...
            try
            {
                if (OrderID != 0)
                {
                    ...
                    if (subscription != null)
                    {
                        ...
                        var Camp = _context.Camps.Include(e => e.Country).Where(c => c.CampId == subscription.EntityId).FirstOrDefault();
                        ...
                        string messageBody = string.Format(builder.HtmlBody,
                           ...
                           Camp.StartDate.Value.ToShortDateString(),
                           Camp.CampTlEn,
                           Camp.Country.CountryTlEn,
                            subscription.Cost,
                           Camp.EndDate.Value.ToShortDateString()
                           );
                        await _emailSender.SendEmailAsync(userSubscriptions.Email, "Camp Subscription", messageBody);
                    }
                }
