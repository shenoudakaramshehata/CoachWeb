...
{
    public class SubscriptionTournamentPaySuccessModel : PageModel
    {
        ...
        public SubscriptionTournamentPaySuccessModel(CoachContext context, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager,
            ...
            try
            {
                if (OrderID != 0)
                {
                    ...
                    if (subscription != null)
                    {
                        ...
                        var Tournament = _context.Tournaments.Include(e=>e.Country).Where(c => c.TournamentId == subscription.EntityId).FirstOrDefault();
                        ...
                        string messageBody = string.Format(builder.HtmlBody,
                           ...
                           Tournament.StartDate.Value.ToShortDateString(),
                           Tournament.TournamentTlEn,
                           Tournament.Country.CountryTlEn,
                            subscription.Cost,
                           Tournament.EndDate.Value.ToShortDateString()
                           );
                        await _emailSender.SendEmailAsync(userSubscriptions.Email, "Tournament Subscription", messageBody);
                    }
                }
