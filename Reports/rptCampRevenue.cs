...
{
    public partial class rptCampRevenue : DevExpress.XtraReports.UI.XtraReport
    {
        public double ResevedTotalCost { get; set; }
        public rptCampRevenue(double totalCost)
        {
            InitializeComponent();
            ResevedTotalCost = totalCost;
        }

        private void rptCampRevenue_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
