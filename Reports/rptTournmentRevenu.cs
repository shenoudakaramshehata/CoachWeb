...
{
    public partial class rptTournmentRevenu : DevExpress.XtraReports.UI.XtraReport
    {
        public double ResevedTotalCost { get; set; }
        public rptTournmentRevenu(double totalCost)
        {
            InitializeComponent();
        ...
        private void rptTournmentRevenu_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
